...
export function ConsentForms() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5">
        {shelterConsentForms?.map((consentForm) => {
          return (
            <Card
              key={consentForm._id}
              ...
              >
                ...
                <AvatarFallback className="rounded-none">
                  <span className="text-6xl font-normal">
                    {consentForm.pet?.name?.charAt(0).toUpperCase() || "Paw"}
                  </span>
                </AvatarFallback>
              </Avatar>
              ...
              <CardContent className="relative px-4 pt-0 flex items-start justify-between">
                ...
                <Avatar className="absolute -top-8 left-4 z-10 h-16 w-16 ring-2 ring-(--primary) rounded-sm">
                  ...
                  <AvatarFallback className="rounded-none">
                    <span className="text-3xl font-normal">
                      {consentForm.adopter.name?.charAt(0).toUpperCase() || "A"}
                    </span>
                  </AvatarFallback>
                </Avatar>
                ...
                <div className="flex flex-col justify-around mt-3 pt-8 flex-1 overflow-hidden">
                  <h3 className="flex items-center text-xs font-semibold min-w-0">
                    <FileText size={"15px"} className="mr-1 flex-shrink-0" />
                ...
                <div className="flex-shrink-0 translate-y-10 cursor-pointer text-muted-foreground hover:text-primary transition-colors">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem>
                        <Link to={`${consentForm._id}`} className="flex gap-1">
                          <Pen /> Chỉnh sửa
                        </Link>
                      </DropdownMenuItem>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Việc xóa bản đồng ý sẽ không thể hoàn tác. Bạn có
                              chắc chắn muốn xóa bản đồng ý này không?
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
