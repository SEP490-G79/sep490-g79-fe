...
export const columns: ColumnDef<AdoptionTemplate>[] = [
  {
    accessorKey: "stt",
    header: ({ column }) => (
      <Button
  ...
  },
  {
    ...
    enableHiding: false,
    cell: ({ row }) => {
      const adoptionTemplates = row.original;
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>
              <Pen /> Edit adoption template
            </DropdownMenuItem>
            <DropdownMenuItem variant="destructive">
              <Trash /> Delete adoption template
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
